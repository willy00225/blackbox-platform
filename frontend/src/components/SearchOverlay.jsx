  ...
  return (
    ...
    >
      ...
      <div className="relative flex-1 flex flex-col bg-transparent">
        {/* Barre de recherche */}
        <div className="p-4 flex items-center gap-3 border-b border-white/10 bg-black/80">
        ...
        {/* ✅ Bouton de fermeture supplémentaire en haut à droite (position absolue) */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-10 text-white hover:text-gold transition"
          aria-label="Fermer"
        >
          <X className="w-6 h-6" />
        </button>
